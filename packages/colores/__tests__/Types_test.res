...
describe("Polished_Types.Int8", () => {
  ...
  test("min 0", () => expect(Int8.make(-1)->Int8.asInt)->toBe(0))

  test("asFloat", () => expect(Int8.make(127)->Int8.toFloat)->toBe(127.0))

  test("fromHEX with 0A", () => expect(Int8.fromHEX('0', 'A')->Int8.asInt)->toBe(10))
...
describe("Polished_Types.RGB", () => {
  ...
  test("make", () =>
    expect((rgb->RGB.red, rgb->RGB.green, rgb->RGB.blue))->toEqual(expectedRGBTuple)
  )

  test("fromPrimitives", () => expect(rgbFromPrimitives)->toEqual(rgb))

  test("red", () => expect(rgb->RGB.red)->toBe(Int8.make(1)))

  test("green", () => expect(rgb->RGB.green)->toBe(Int8.make(127)))
...
describe("Polished_Types.RGBA", () => {
  ...
  let expectedRGBATuple = (Int8.make(0), Int8.make(127), Int8.make(255), Percent.make(0.5))

  test("make", () =>
    expect((rgba->RGBA.red, rgba->RGBA.green, rgba->RGBA.blue, rgba->RGBA.alpha))->toEqual(
      expectedRGBATuple,
    )
  )

  test("fromPrimitives", () => expect(rgbaFromPrimitives)->toEqual(rgba))

  test("red", () => expect(rgba->RGBA.red)->toBe(Int8.make(0)))

  test("green", () => expect(rgba->RGBA.green)->toBe(Int8.make(127)))

  test("blue", () => expect(rgba->RGBA.blue)->toBe(Int8.make(255)))
...
describe("Polished_Types.HEX", () => {
  ...
  test("asTuple", () => expect(hex->HEX.asTuple)->toEqual(('0', '0', '0', '8', 'b', '5')))

  test("asString", () => expect(hex->HEX.asString)->toBe("0008b5"))
...
describe("Polished_Types.HSL", () => {
  ...
  let expectedHSLTuple = (Degree.make(180.0), Percent.make(0.7), Percent.make(0.5))

  test("make", () =>
    expect((hsl->HSL.hue, hsl->HSL.saturation, hsl->HSL.lightness))->toEqual(expectedHSLTuple)
  )

  test("fromPrimitives", () => expect(hslFromPrimitives)->toEqual(hsl))

  test("hue", () => expect(hsl->HSL.hue)->toBe(Degree.make(180.0)))

  test("saturation", () => expect(hsl->HSL.saturation)->toBe(Percent.make(0.7)))
...
describe("Polished_Types.HSLA", () => {
  ...
  test("fromPrimitives", () => expect(hslaFromPrimitives)->toEqual(hsla))

  test("hue", () => expect(hsla->HSLA.hue)->toBe(Degree.make(180.0)))

  test("saturation", () => expect(hsla->HSLA.saturation)->toBe(Percent.make(0.7)))

  test("lightness", () => expect(hsla->HSLA.lightness)->toBe(Percent.make(0.5)))

  test("alpha", () => expect(hsla->HSLA.alpha)->toBe(Percent.make(0.8)))
})
