...
module Impl = {
  let shade = (color: color, amount: Percent.t): color =>
    Color_Mix.mix(RGB(RGB.fromPrimitives(0, 0, 0)), color, amount)
  ...
  let shadeRGBA = (rgba: RGBA.t, amount: Percent.t): color => {
    ...
    Color_Transparentize.transparentize(shadedRgb, alpha)
  }
  ...
  let shadeHSLA = (hsla: HSLA.t, amount: Percent.t): color => {
    ...
    Color_Transparentize.transparentize(shadedHsl, alpha)
  }
}
